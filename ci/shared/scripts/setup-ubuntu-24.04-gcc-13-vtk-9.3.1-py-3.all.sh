...
#
# vt-tv, gcc-13, ubuntu, vtk 9.3.1, py3[8-12] - Installation
# Note: requires
...
chmod u+x *.sh
ls -l
./packages.sh "ca-certificates" "curl" "git" "jq" "less" "libomp5" "libunwind-dev make-guile" "ninja-build" "valgrind" "wget" "zlib1g" "zlib1g-dev" "ccache" "python3" "gcc-13" "g++-13"
./mesa.sh
./conda.sh
