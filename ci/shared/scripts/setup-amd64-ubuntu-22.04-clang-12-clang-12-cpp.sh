...
#
# clang-12, ubuntu, mpich - Installation
# Note: requires
...
chmod u+x *.sh
ls -l
./packages.sh "curl" "jq" "less" "libomp5" "libunwind-dev make-guile" "ninja-build" "valgrind" "zlib1g" "zlib1g-dev" "ccache" "python3" "clang-12" "llvm-12"
./cmake.sh "3.23.4"
./libunwind.sh "1.6.2"
./mpich.sh "4.0.2" "-j4"
